    ...
    public class UserController : Controller
    {
        ...
        public ActionResult Create(ThanhVien model)
        {
            if (ModelState.IsValid)
            {
                ...
                string subject = "Bất Động Sản  | Đăng ký";
                //string path = Path.Combine(HttpRuntime.AppDomainAppPath, "D:/BDS_KimHuynh/BDS/BDS/MailTemplate/MailRegister.html");
                string path = Path.Combine(HttpRuntime.AppDomainAppPath, "C:/Users/FPTSHOP/source/repos/BDS/BDS/BDS/MailTemplate/MailRegister.html");
               ...
               // string body = "Chúc mừng " + model.HoTenTV + " đã Đăng ký tài khoản thành công ! TenTK : " + model.UserName + "| MK: " + model.Pw;
                ...
                {
                    ModelState.AddModelError("", "Thêm mới không thành công UserController.cs 1");
                }
            }
            return View(model);
        }
        ...
        public ActionResult LienHe(LienHe model)
        {
            ...
            string toAddress = model.Email;
            string subject = "Bất Động Sản  | Liên hệ";
            ...
            string path = Path.Combine(HttpRuntime.AppDomainAppPath, "C:/Users/FPTSHOP/source/repos/BDS/BDS/BDS/MailTemplate/MailLienHe.html");
            string body = System.IO.File.ReadAllText(path);
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("", "Thêm mới không thành công UserController.cs 2");
                }
            }
            return View(model);
        }
        ...
        public ActionResult InformationCustomer(KhachHang model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("", "Thêm mới không thành công UserController.cs 3");
                }
            }
            return View(model);
        }
