    ...
    public class DatThueController : Controller
    {
        ...
        public ActionResult DatThueNgay()
        {
            ...
            if (Session["Username"] !=null)
            {
                ...
                string subject = "Bất Động Sản  | Đặt thuê - Thành viên";
                string path = Path.Combine(HttpRuntime.AppDomainAppPath, "D:/BDS_KimHuynh/BDS/BDS/MailTemplate/MailDatThue.html");
...

            {
                ...
                string subject= "Bất Động Sản  | Đặt thuê - Khách hàng";
                string path = Path.Combine(HttpRuntime.AppDomainAppPath, "D:/BDS_KimHuynh/WebBDS/kimhuynh/VOHUUHAI-151250533116/BDS/BDS/MailTemplate/MailDatThue.html");
                string body = System.IO.File.ReadAllText(path);
